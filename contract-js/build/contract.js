...
let MinerNode = (_dec = NearBindgen({}), _dec2 = initialize({}), _dec3 = call({}), _dec4 = call({}), _dec5 = call({}), _dec6 = view({}), _dec7 = view({
  payableFunction: true
}), _dec(_class = (_class2 = class MinerNode {
  //Public key of a subaccount, used to find the node
  // Failure counts can be managed by the oracle
  // lastRun: Date;
  // lastBounty: address w/ failure
  offline = false; //If a node fails 100% of the time over some measure, we'll deactivate it. They can reactivate themselves using the client.

  coreCount = 0;
  coreSpeed = 0; //Should be int of hertz, such as 3600000000 for 3.6GHz

  arch = ""; //TODO: This should be an enum

  memory = 0;
  gpus = new UnorderedSet('gpus'); //Unordered map of software right? Python will want to know.

  installedSoftware = new UnorderedMap('installed-software'); //Should be an unordered map af software

  init() {
    this.owner = signerAccountId();
    this.oracle = predecessorAccountId();
  }
  ...
  updateHardware({
    ...
    assert(signerAccountId() === this.owner, "Only the owner can update hardware");
...
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "updateHardware", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "updateHardware"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "updateSoftware", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "updateSoftware"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "updateAllSoftware", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "updateAllSoftware"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "hasSoftware", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "hasSoftware"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "setOnlineOffline", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "setOnlineOffline"), _class2.prototype)), _class2)) || _class); //Ideas for supported software:
...
function setOnlineOffline() {
  ...
  let _result = _contract.setOnlineOffline(_args);
...
function hasSoftware() {
  ...
  let _result = _contract.hasSoftware(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(MinerNode._serialize(_result));
}
...
function updateSoftware() {
  ...
  let _result = _contract.updateSoftware(_args);
...
export { MinerNode, hasSoftware, init, setOnlineOffline, updateAllSoftware, updateHardware, updateSoftware };
